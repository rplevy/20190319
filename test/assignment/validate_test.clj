...
(deftest validation-tests
  (is (not (base/pipe-delimited? "Wilson | Freddie | male | beige | 5/2/1975")))
  (is (not (base/comma-delimited? "Moore, Harry, male, pink, 9/2/2015")))
  (is (not (base/space-delimited? "Davis Emily female turquoise 9/8/2010")))
  (is (= :space-delimited
